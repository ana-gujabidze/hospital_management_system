    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post( // eslint-disable-line no-unused-vars
                REGISTER_URL,
                JSON.stringify({ username: user, password: pwd, matchPassword: matchPwd, email: email, firstName: firstName, lastName: lastName, symptoms: symptoms, disease: disease, mobile: mobile.replace, status: false }),
                {
